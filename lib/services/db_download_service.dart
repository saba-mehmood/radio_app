...
import 'package:radio_app/utils/db_service.dart';
import 'package:radio_app/utils/webservice.dart';

class DBDownloadService {
  //checking for local data availability
...
static Future<RadioAPIModel> fetchAllRadios() async{
    final serviceResponse = await WebServices().getData(Config.api_URL,new RadioAPIModel());
